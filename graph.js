class Graph {
    ...
    constructor(element, options = {}) {
        ...
        Graph.prototype._checkSiblingError.call(this, this.element);    // this._checkSiblingError
        
        for (const parent in subtrees) {
            Graph.prototype._checkSiblingError.call(this, subtrees[parent]);    // this._checkSiblingError
        }
